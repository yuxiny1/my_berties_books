...
CREATE TABLE users(firstName varchar(50) NOT NULL, lastName varchar(50) NOT NULL, emailAddress varchar(50) NOT NULL, password varchar(255) NOT NULL, PRIMARY KEY(emailAddress));
select *from users;
