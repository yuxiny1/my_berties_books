...
CREATE TABLE users(LastName varchar(255) NOT NULL, firstName varchar(255) NOT NULL,userName varchar(255)NOT NULL unique, emailAddress varchar(255) NOT NULL , password varchar(255) NOT NULL, PRIMARY KEY(userName));
